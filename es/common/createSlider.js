  ...
  return _a = /*#__PURE__*/function (_Component) {
    ...
    function ComponentEnhancer(props) {
      ...
      _this.onMouseDown = function (e) {
        ...
        var isVertical = _this.props.vertical; // get the slider position related to the mouse

        var position = utils.getMousePosition(isVertical, e); // update position

        var updatePosition = true; // check if the event came from a slider handle

        if (!utils.isEventFromHandle(e, _this.handlesRefs)) {
          // it did not, reset drag offset if we are snapping to
          if (_this.props.snapToPosition !== false) {
            _this.dragOffset = 0;
          } else {
        ...
        if (_this.props.onSnapToPosition) {
          _this.props.onSnapToPosition(position, _this.calcValueByPos ? _this.calcValueByPos(position) : null);
      ...
      _this.onMouseUp = function () {
        if (_this.handlesRefs[_this.prevMovedHandleIndex] && _this.props.snapToPosition !== false) {
    ...
    _createClass(ComponentEnhancer, [{
      ...
      value: function render() {
        ...
        var _this$props6 = this.props,
            ...
            onRailMouseDown = _this$props6.onRailMouseDown;
